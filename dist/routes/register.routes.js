...
router.post("/Athletes", async (req, res) => {
    try {
        const response = await api_1.registerService.post("/AthletesRegister", req.body);
 ...
 *                   example: "Error interno del servidor"
 */
router.put("/AthleteUpdate/:idAthlete", async (req, res) => {
    try {
        const { params: { idAthlete }, } = req;
        const response = await api_1.registerService.put(`/AthleteUpdate/${idAthlete}`, req.body);
        res.json(response.data);
    }
    catch (error) {
        (0, handleAxiosError_1.default)(error, req, res);
...
router.get("/athletes", async (req, res) => {
    try {
        ...
        const response = await api_1.registerService.get(`/AthletesAll`, req.body);
        res.json(response.data);
    }
    catch (error) {
        (0, handleAxiosError_1.default)(error, req, res);
